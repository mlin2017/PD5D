...
SeuratObject <- readRDS("/n/scratch3/users/j/jap0606/FullIntegration_OutlierSamplesRemoved_NHSC/FullIntegrationOSR_MTG_NHSC_Part2.rds")
...
saveRDS(SeuratObjectSinglets,"/n/scratch3/users/j/jap0606/FullIntegration_OutlierSamplesRemoved_NHSC/FullIntegrationOSR_MTG_NHSC_Part3.rds")
