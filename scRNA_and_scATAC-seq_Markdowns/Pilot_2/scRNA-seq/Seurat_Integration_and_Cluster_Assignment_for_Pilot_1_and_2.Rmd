...
Run Harmony
```{r}
Pilot1and2_MB <- RunHarmony(Pilot1and2_MB, group.by.vars = c("sample_ID","case"), plot_convergence = TRUE, reduction = "glmpca", theta = c(1,1))
```
...
```{r}
Pilot1and2_MB <- RunUMAP(Pilot1and2_MB, reduction = "harmony", dims = 1:21)
```
...
```
```{R}
VlnPlot(Pilot1and2_MB, features = c("SLC17A7"),pt.size = 0)
```
...
Pilot1and2_MB <- RenameIdents(Pilot1and2_MB, `1` = "Oligodendrocytes", `2` = "Astrocytes",
                      `3` = "Oligodendrocytes", `4` = "GLU_GABA_Neurons", `5` = "Microglia",
                      `6` = "OPCs", `7` = "Endothelial", `8` = "DA Neurons 1",`9` = "Endothelial",
                      `10` = "GLU Neurons", `11` = "Oligodendrocytes",`12` = "GABA Neurons",
