...
saveRDS(SeuratObject,"/n/scratch3/users/j/jap0606/Midbrain/Batches1-15_Midbrain_Combined_Matrix.rds")
...
SeuratObject <- RunHarmony(SeuratObject, group.by.vars = c("sample_id","batch","sex","age_bracket","case"), plot_convergence = TRUE, reduction = "glmpca", theta = c(0.4,0.4,0.4,0.4,0.4))
...
saveRDS(SeuratObject,"/n/scratch3/users/j/jap0606/Midbrain/Batches1-15_Midbrain_redpca_Part1.rds")
