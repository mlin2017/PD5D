...
if (length(Ident.PDvsHC_Prog.Markers$gene) != 0) {
        ...
        Ident.PDvsHC_Prog.Markers$BF_p_val <- 0.05/TotalGenes
        Ident.PDvsHC_Prog.Markers <- Ident.PDvsHC_Prog.Markers[Ident.PDvsHC_Prog.Markers$p_val <= unique(Ident.PDvsHC_Prog.Markers$BF_p_val),]
        if (length(Ident.PDvsHC_Prog.Markers$gene) != 0) {
...
if (length(Ident.ILBvsHC_Prog.Markers$gene) != 0){
        ...
        Ident.ILBvsHC_Prog.Markers$BF_p_val <- 0.05/TotalGenes
        Ident.ILBvsHC_Prog.Markers <- Ident.ILBvsHC_Prog.Markers[Ident.ILBvsHC_Prog.Markers$p_val <= unique(Ident.ILBvsHC_Prog.Markers$BF_p_val),]
        if (length(Ident.ILBvsHC_Prog.Markers$gene) != 0){        
...
if (length(Ident.PDvsILB_Prog.Markers$gene) != 0) {
        ...
        Ident.PDvsILB_Prog.Markers$BF_p_val <- 0.05/TotalGenes
        Ident.PDvsILB_Prog.Markers <- Ident.PDvsILB_Prog.Markers[Ident.PDvsILB_Prog.Markers$p_val <= unique(Ident.PDvsILB_Prog.Markers$BF_p_val),]
        if (length(Ident.PDvsILB_Prog.Markers$gene) != 0) {        
...
if (length(Ident.PD_and_ILBvsHC_Prog.Markers$gene) != 0){
        ...
        Ident.PD_and_ILBvsHC_Prog.Markers$BF_p_val <- 0.05/TotalGenes
        Ident.PD_and_ILBvsHC_Prog.Markers <- Ident.PD_and_ILBvsHC_Prog.Markers[Ident.PD_and_ILBvsHC_Prog.Markers$p_val <= unique(Ident.PD_and_ILBvsHC_Prog.Markers$BF_p_val),]
        if (length(Ident.PD_and_ILBvsHC_Prog.Markers$gene) != 0){
