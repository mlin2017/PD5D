...
write.table(DE_Aggr_Table, file = "../Files/PD_vs_HC_DEGenes_Cluster_AggregateTable.csv", quote = FALSE, row.names = FALSE,col.names = TRUE, sep = ",")
...
ggsave(GSEA_Human_PFC_Heatmap,filename = "../Figures/DE_Gene_Heatmaps/PD_vs_HC/PD_vs_HC_FullIntegrationOSR_Top30DEGenes_Heatmap.pdf", device = "pdf", height = 8, width = 8, units = "in")
...
write.table(GenesOrder, file = "../Figures/DE_Gene_Heatmaps/MostDEGenesOrder.tsv", sep = "\t", quote = FALSE, row.names = FALSE)

Gene_Table <- read.delim("../Figures/DE_Gene_Heatmaps/MostDEGenesOrder.tsv")

Gene_Table_TOP <- Gene_Table
...
ggsave(GSEA_Human_PFC_Heatmap,filename = "../Figures/DE_Gene_Heatmaps/PD_vs_HC/PD_vs_HC_FullIntegrationOSR_TopMostCommon30DEGenes_Heatmap.pdf", device = "pdf", height = 8, width = 8, units = "in")
...
write.table(GenesOrder, file = "../Figures/DE_Gene_Heatmaps/MostCommonDEGenesOrder.tsv", sep = "\t", quote = FALSE, row.names = FALSE)
...
ggsave(UniquePathwayNumberSummaryChart,filename = paste("../Figures/DE_Gene_Heatmaps/PD_vs_HC/PD_vs_HC_UniqueGeneNumberSummaryChart.pdf",sep = ""), device = "pdf", width = 6, height = 4, units = "in")
...
ggsave(UniquePathwayNormalisedSummaryChart,filename = paste("../Figures/DE_Gene_Heatmaps/PD_vs_HC/PD_vs_HC_UniqueGenesNormalisedSummaryChart.pdf",sep = ""), device = "pdf", width = 6, height = 4, units = "in")
...
ggsave(GSEA_Human_PFC_Heatmap,filename = "../Figures/DE_Gene_Heatmaps/PD_vs_HC/PD_vs_HC_GLU_Neurons_FullIntegrationOSR_Top30DEGenes_Heatmap.pdf", device = "pdf", height = 8, width = 8, units = "in")
...
ggsave(GSEA_Human_PFC_Heatmap,filename = "../Figures/DE_Gene_Heatmaps/PD_vs_HC/PD_vs_HC_GLU_Neurons_FullIntegrationOSR_TopMostCommon30DEGenes_Heatmap.pdf", device = "pdf", height = 8, width = 8, units = "in")
...
write.table(Unique_genes_table, file = "../Figures/DE_Gene_Heatmaps/PD_vs_HC/PD_vs_HC_GLU_Neurons_ExclusiveGenesTable.tsv", sep = "\t", quote = FALSE, row.names = FALSE)
...
ggsave(GSEA_Human_PFC_Heatmap,filename = "../Figures/DE_Gene_Heatmaps/PD_vs_HC/PD_vs_HC_GABA_Neurons_FullIntegrationOSR_Top30DEGenes_Heatmap.pdf", device = "pdf", height = 8, width = 8, units = "in")
...
ggsave(GSEA_Human_PFC_Heatmap,filename = "../Figures/DE_Gene_Heatmaps/PD_vs_HC/PD_vs_HC_GABA_Neurons_FullIntegrationOSR_TopMostCommon30DEGenes_Heatmap.pdf", device = "pdf", height = 8, width = 8, units = "in")
...
write.table(Unique_genes_table, file = "../Figures/DE_Gene_Heatmaps/PD_vs_HC/PD_vs_HC_GABA_Neurons_ExclusiveGenesTable.tsv", sep = "\t", quote = FALSE, row.names = FALSE)
...
ggsave(GSEA_Human_PFC_Heatmap,filename = "../Figures/DE_Gene_Heatmaps/PD_vs_HC/PD_vs_HC_GlialCells_FullIntegrationOSR_Top30DEGenes_Heatmap.pdf", device = "pdf", height = 8, width = 8, units = "in")
...
ggsave(GSEA_Human_PFC_Heatmap,filename = "../Figures/DE_Gene_Heatmaps/PD_vs_HC/PD_vs_HC_GlialCells_Neurons_FullIntegrationOSR_TopMostCommon30DEGenes_Heatmap.pdf", device = "pdf", height = 8, width = 8, units = "in")
...
write.table(Unique_genes_table, file = "../Figures/DE_Gene_Heatmaps/PD_vs_HC/PD_vs_HC_GlialCells_ExclusiveGenesTable.tsv", sep = "\t", quote = FALSE, row.names = FALSE)
