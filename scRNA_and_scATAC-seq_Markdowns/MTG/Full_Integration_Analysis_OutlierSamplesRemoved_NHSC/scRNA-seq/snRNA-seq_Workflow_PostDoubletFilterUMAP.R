...
SeuratObject <- readRDS("/n/scratch3/users/j/jap0606/FullIntegration_OutlierSamplesRemoved_NHSC/FullIntegrationOSR_MTG_NHSC_Part3.rds")
...
saveRDS(SeuratObject,"/n/scratch3/users/j/jap0606/FullIntegration_OutlierSamplesRemoved_NHSC/FullIntegrationOSR_MTG_NHSC_PostClusterQCUMAP.rds")
