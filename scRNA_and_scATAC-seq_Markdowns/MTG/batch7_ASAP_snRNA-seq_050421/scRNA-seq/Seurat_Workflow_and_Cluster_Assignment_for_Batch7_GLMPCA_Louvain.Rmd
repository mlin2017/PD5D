...
```{r}
Batch7_MTG_Case_UMAP <- DimPlot(Batch7_MTG, reduction = "umap", label = TRUE, ncol = 1, label.size = 2.5) + 
...
ggsave(Batch7_MTG_Case_UMAP, filename = "Figures/Batch7_MTG_GLMPCA_Louvain_UMAP.pdf", device = "pdf", width = 6, height = 6, units = "in")
```
