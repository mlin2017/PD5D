...
```{r}
Batch5_MTG <- FindNeighbors(Batch5_MTG, reduction = "harmony", dims = 1:9)
...
```{r}
Batch5_MTG <- RunUMAP(Batch5_MTG, reduction = "harmony", dims = 1:9)
```

run tsne based on top 10 harmony axis: 

```{r}
Batch5_MTG <- RunTSNE(Batch5_MTG, reduction = "harmony", dims = 1:9)
```
