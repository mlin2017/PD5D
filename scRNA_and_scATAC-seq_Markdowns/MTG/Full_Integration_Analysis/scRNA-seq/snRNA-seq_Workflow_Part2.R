...
SeuratObject <- readRDS("/n/scratch3/users/j/jap0606/FullIntegration/FullIntegration_MTG_Part1.rds")
...
saveRDS(SeuratObject,"/n/scratch3/users/j/jap0606/FullIntegration/FullIntegration_MTG_Part2.rds")
