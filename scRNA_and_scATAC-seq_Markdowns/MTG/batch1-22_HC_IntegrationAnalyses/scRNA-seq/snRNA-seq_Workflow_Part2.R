...
SeuratObject <- readRDS("/n/scratch3/users/j/jap0606/batch1-22_HC/Batch1-22_MTG_HC_Part1.rds")

SeuratObject <- FindNeighbors(SeuratObject, reduction = "harmony", dims = 1:35)
SeuratObject <- FindClusters(SeuratObject, resolution = 0.5, algorithm = 4, method = "igraph")
SeuratObject <- RunUMAP(SeuratObject, reduction = "harmony", dims = 1:35)

saveRDS(SeuratObject,"/n/scratch3/users/j/jap0606/batch1-22_HC/Batch1-22_MTG_HC_Part2.rds")
...
ggsave(Batch1to22_barchart,filename = "Files/Batch1-22_HC_Marker_Barchart", device = "pdf", width = 12, height = 14, units = "in")
