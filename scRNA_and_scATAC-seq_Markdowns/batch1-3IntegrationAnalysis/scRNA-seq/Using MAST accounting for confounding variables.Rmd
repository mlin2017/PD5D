...
```{R}
Batch567_MTG <- RenameIdents(Batch567_MTG, `0` = "Oligodendrocytes", `1` = "GLU_Neurons", `2` = "GLU_Neurons",
                      `3` = "GLU_Neurons", `4` = "GABA_Neurons", `5` = "GABA_Neurons",
                      `6` = "GLU_Neurons", `7` = "Astrocytes", `8` = "GLU_Neurons",`9` = "GABA_Neurons",
                      `10` = "GLU_Neurons", `11` = "GLU_Neurons",`12` = "GLU_Neurons",
                      `13` = "Microglia",`14` = "Astrocytes",
                      `15` = "Oligodendrocytes", `16`="GABA_Neurons", `17`="GLU_Neurons", `18`="Endothelial",`19`="Endothelial",`20`="Oligodendrocytes",`21`="GABA_Neurons",`22`="GABA_Neurons")
```
...
Astrocytefilter@meta.data$DetRate <- as.vector(scale(colSums(Astrocytefilter@assays$RNA@counts)))
...
Astrocytes.PD_Prog.Markers <- FindMarkers(Astrocytefilter, ident.1 = "PD", ident.2 = "HC", verbose = FALSE, test.use = "MAST", latent.vars = c("sex","DetRate"))
...
MASTDEcasePerCluster <- function(SeuObj,Cluster_Ident){
     ...
     IdentScatter_PDvsHC <- ggplot(Top_Ident.PDvsHC_Prog.Markers, aes(HC_mean, PD_mean, color = Status)) + geom_point(size = 0.5) + ggtitle("Astrocytes") +
                theme_cowplot(12) +
                theme(legend.position = "none",
                      plot.title = element_text(hjust = 0.5)) +
                xlab("HC Mean") +
        ...
        Ident.ILBvsHC_Prog.Markers <-
                Ident.ILBvsHC_Prog.Markers[Ident.ILBvsHC_Prog.Markers$p_val_adj <= 0.05,]
     ...
     IdentScatter_ILBvsHC <- ggplot(Top_Ident.ILBvsHC_Prog.Markers, aes(HC_mean, ILB_mean, color = Status)) + geom_point(size = 0.5) + ggtitle("Astrocytes") +
                theme_cowplot(12) +
                theme(legend.position = "none",
                      plot.title = element_text(hjust = 0.5)) +
                xlab("HC Mean") +
     ...
     IdentScatter_PDvsILB <- ggplot(Top_Ident.PDvsILB_Prog.Markers, aes(ILB_mean, PD_mean, color = Status)) + geom_point(size = 0.5) + ggtitle("Astrocytes") +
                theme_cowplot(12) +
                theme(legend.position = "none",
                      plot.title = element_text(hjust = 0.5)) +
                xlab("ILB Mean") +
