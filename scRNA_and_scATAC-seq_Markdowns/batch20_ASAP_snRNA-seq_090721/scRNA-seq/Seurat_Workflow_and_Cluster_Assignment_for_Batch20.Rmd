---
title: "Seurat Workflow and Cluster Assignment for Batch 19"
...
VlnPlot(Batch20_MTG, features = c("nFeature_RNA", "nCount_RNA", "percent.mt"), ncol = 3)
```
...
```{r}
Batch20_MTG <- FindNeighbors(Batch20_MTG, reduction = "harmony", dims = 1:11)
...
```{r}
Batch20_MTG <- RunUMAP(Batch20_MTG, reduction = "harmony", dims = 1:11)
```
