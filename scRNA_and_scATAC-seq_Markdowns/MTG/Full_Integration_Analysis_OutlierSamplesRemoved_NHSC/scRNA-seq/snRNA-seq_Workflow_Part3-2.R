...
SeuratObject <- RenameIdents(SeuratObject, `1` = "GLU_Neurons_1", `2` = "Oligodendrocytes", `3` = "GLU_Neurons_2", `4` = "GLU_Neurons_3", `5` = "GLU_Neurons_4", `6` = "Astrocytes", `7` = "GLU_Neurons_5", `8` = "GLU_Neurons_6",`9` = "GLU_Neurons_7",`10` = "GABA_Neurons_1", `11` = "GLU_Neurons_8", `12` = "Microglia",`13` = "GABA_Neurons_2",`14` = "OPCs",`15` = "GABA_Neurons_3", `16`= "GABA_Neurons_4", `17`="GABA_Neurons_5", `18`="Endothelial_Cells_1", `19`="Endothelial_Cells_2", `21` = "GABA_Neurons_6", `22` = "GLU_Neurons_9", `23` = "GLU_Neurons_10", `24` = "GLU_Neurons_11", `25` = "GLU_Neurons_12", `26` = "GLU_Neurons_13",`27` = "GLU_Neurons_14", `30` = "Cajal_Retzius_1", `32` = "GLU_Neurons_15", `33` = "GLU_Neurons_16",`34` = "GABA_Neurons_7", `35` = "GLU_Neurons_17", `36` = "GABA_Neurons_8", `38` = "GABA_Neurons_9", `41` = "GABA_Neurons_10", `42` = "GABA_Neurons_11",`43` = "Cajal_Retzius_2", `44` = "GLU_Neurons_18", `45` = "GLU_Neurons_19", `47` = "TEMRA_T_Cells", `48` = "GABA_Neurons_12", `50` = "GABA_Neurons_13", `54` = "GLU_Neurons_20", `66` = "Unknown_Cluster_66")


CellType_SplitCase_ProportionTable <- as.data.frame(prop.table(table(Idents(SeuratObject), SeuratObject$case), margin = 2))

write.table(CellType_SplitCase_ProportionTable, file = "Files/Subcluster_SplitCase_ProportionTable.tsv", quote = FALSE, row.names = FALSE, sep = "\t")
...
write.table(CellType_SplitCase_NumbersTable, file = "Files/Subcluster_SplitCase_NumbersTable.tsv", quote = FALSE, row.names = FALSE, sep = "\t")
...
clusteridents <- rbind("/n/scratch3/users/j/jap0606/FullIntegration/FullIntegrationOSR_MTG_PostClusterQCUMAP.rds",data.frame(as.vector(unique(SeuratObject@active.ident))))
