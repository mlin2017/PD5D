...
```{r}
Batch6_MTG <- subset(Batch6_MTG, subset = nFeature_RNA > 200 & percent.mt < 5)
```
...
```{r}
Batch6_MTG <- FindNeighbors(Batch6_MTG, reduction = "harmony", dims = 1:17)
...
```{r}
Batch6_MTG <- RunUMAP(Batch6_MTG, reduction = "harmony", dims = 1:17)
```
