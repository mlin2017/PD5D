...
Run Harmony
```{r}
Batch567_MTG <- RunHarmony(Batch567_MTG, group.by.vars = c("batch","sex","age_bracket"), reduction = "glmpca", plot_convergence = TRUE, theta = c(0.66,0.66,0.66))
```
...
ggsave(UMAPclusters, filename = "Figures/Unassigned_BatchSexAgeHarmony_GLMAPCA_UMAPclusters_scRNA_seq_Batch123_MTG.pdf", device = "pdf", width = 6, height = 4, units = "in")
```
...
ggsave(UMAPclusters, filename = "Figures/Unassigned_BatchSexAgeHarmony_CaseSplit_GLMPCA_UMAPclusters_scRNA_seq_Batch123_MTG.pdf", device = "pdf", width = 6, height = 10, units = "in")
```
...
ggsave(UMAPclusters, filename = "Figures/Unassigned_BatchSexAgeHarmony_CaseGroup_GLMPCA_UMAPclusters_scRNA_seq_Batch123_MTG.pdf", device = "pdf", width = 6, height = 4, units = "in")
```
