---
title: "Final MAST DE Analysis - Subclusters"
...
MASTDEcasePerCluster <- function(SeuObj,Cluster_Ident){
        ...
        if (dim(Ident.PDvsHC_Prog.Markers[1] != 0)){
        ...
        write.csv(Ident.PDvsHC_Prog.Markers,file = paste("Files/DE_Genes_Subclusters/All_SigGenes_",Cluster_Ident,"_Markers_HC_vs_PD.csv",sep = ""), quote = FALSE)
        }
        ...
        if (dim(Ident.ILBvsHC_Prog.Markers[1] != 0)){
        ...
        write.csv(Ident.ILBvsHC_Prog.Markers,file = paste("Files/DE_Genes_Subclusters/All_SigGenes_",Cluster_Ident,"_Markers_HC_vs_ILB.csv",sep = ""), quote = FALSE)
        }
        ...
        if (dim(Ident.PDvsILB_Prog.Markers[1] != 0)){
        ...
        write.csv(Ident.PDvsILB_Prog.Markers,file = paste("Files/DE_Genes_Subclusters/All_SigGenes_",Cluster_Ident,"_Markers_ILB_vs_PD.csv",sep = ""), quote = FALSE)
        }
