...
SeuratObject <- readRDS("/n/scratch3/users/j/jap0606/Midbrain/Batches1-15_Midbrain_reducedpcareducedharmony_Part3.rds")
...
saveRDS(SeuratObject,"/n/scratch3/users/j/jap0606/Midbrain/Batches1-15_Midbrain_reducedpcareducedharmony_PostClusterQCUMAP.rds")
...
MarkerGenes <- c("ENO2","RBFOX3","TH","SLC6A3","SLC18A2","SLC17A6","SLC17A7","SLC32A1","GAD1","GAD2","AQP4","GFAP","PLP1","MBP","OLIG1","VCAN","BCAN","CX3CR1","P2RY12","FLT1","CLDN5","IL7R","CD96","CD8A","RELN","CALB2","CNR1","PTPRC","CD27","CD28","CCR7","PRF1","DCX","SOX2","NES","NEUROD1")
