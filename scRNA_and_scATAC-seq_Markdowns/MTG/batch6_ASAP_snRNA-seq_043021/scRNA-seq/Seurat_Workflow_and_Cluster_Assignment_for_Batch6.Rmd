...
Run Harmony
```{r}
Batch6_MTG <- RunHarmony(Batch6_MTG, group.by.vars = c("case","sample_ID"), reduction = "glmpca", plot_convergence = TRUE, theta = c(1,1))
```
...
```{R}
ElbowPlot(Batch6_MTG, reduction = "harmony")
...
```{r}
Batch6_MTG <- FindNeighbors(Batch6_MTG, reduction = "harmony", dims = 1:16)
...
```{r}
Batch6_MTG <- RunUMAP(Batch6_MTG, reduction = "harmony", dims = 1:16)
```
