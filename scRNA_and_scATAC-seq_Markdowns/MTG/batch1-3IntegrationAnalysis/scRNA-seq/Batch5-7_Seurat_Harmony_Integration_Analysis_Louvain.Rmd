...
ggsave(UMAPclusters, filename = "Figures/Unassigned_Louvain_FullCorrectionHarmony_GLMAPCA_UMAPclusters_scRNA_seq_Batch123_MTG.pdf", device = "pdf", width = 6, height = 4, units = "in")
```
...
ggsave(UMAPclusters, filename = "Figures/Unassigned_Louvain_FullCorrectionHarmony_CaseSplit_GLMPCA_UMAPclusters_scRNA_seq_Batch123_MTG.pdf", device = "pdf", width = 6, height = 10, units = "in")
```
...
ggsave(UMAPclusters, filename = "Figures/Unassigned_Louvain_FullCorrectionHarmony_CaseGroup_GLMPCA_UMAPclusters_scRNA_seq_Batch123_MTG.pdf", device = "pdf", width = 6, height = 4, units = "in")
```
