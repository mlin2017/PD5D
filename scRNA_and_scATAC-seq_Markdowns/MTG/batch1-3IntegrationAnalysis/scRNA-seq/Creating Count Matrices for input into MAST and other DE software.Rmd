...
colnames(Astrocyte_Counts) <- paste(coldata$Sample, coldata$Case,sep="_")

write.table(Astrocyte_Counts, "Files/Astrocytes_RAWCOUNTS.tsv",sep = "\t", row.names = TRUE, col.names = TRUE, quote = FALSE)
```
