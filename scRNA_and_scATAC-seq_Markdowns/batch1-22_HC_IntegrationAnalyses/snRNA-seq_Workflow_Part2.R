...
SeuratObject <- FindNeighbors(SeuratObject, reduction = "harmony", dims = 1:30)
SeuratObject <- FindClusters(SeuratObject, resolution = 0.5, algorithm = 4, method = "igraph")
SeuratObject <- RunUMAP(SeuratObject, reduction = "harmony", dims = 1:30)
...
ggsave(Batch1to22_barchart,filename = "Files/Batch1to22_Marker_Barchart", device = "pdf", width = 12, height = 14, units = "in")
