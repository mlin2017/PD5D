...
write.table(GSEA_Aggr_Table, file = "../Files/PD_vs_HC_GSEA_AssignedClusters_AggregateTable.csv", quote = FALSE, row.names = FALSE,col.names = TRUE, sep = ",")
...
write.table(GSEA_Aggr_Table_PvalSorted, file = "../Files/PD_vs_HC_GSEA_AssignedClusters_AggregateTable_PvalSorted.csv", quote = FALSE, row.names = FALSE,col.names = TRUE, sep = ",")
...
ggsave(GSEA_Human_PFC_Heatmap,filename = "../Figures/GSEA_and_DE_Gene_Heatmaps/PD_vs_HC/PD_vs_HC_FullIntegrationOSR_GSEA_C2_Top30Pathways_Heatmap.pdf", device = "pdf", height = 18, width = 12, units = "in")
...
write.table(PathwaysOrder, file = "../Figures/GSEA_and_DE_Gene_Heatmaps/MostDEPathwaysOrder.tsv", sep = "\t", quote = FALSE, row.names = FALSE)

Pathway_Table <- read.delim("../Figures/GSEA_and_DE_Gene_Heatmaps/MostDEPathwaysOrder.tsv")

Pathway_Table_TOP <- Pathway_Table
...
ggsave(GSEA_Human_PFC_Heatmap,filename = "../Figures/GSEA_and_DE_Gene_Heatmaps/PD_vs_HC/PD_vs_HC_FullIntegrationOSR_GSEA_C2_Top30CommonPathways_Heatmap.pdf", device = "pdf", height = 18, width = 12, units = "in")
...
write.table(PathwaysOrder, file = "../Figures/GSEA_and_DE_Gene_Heatmaps/MostCommonDEPathwaysOrder.tsv", sep = "\t", quote = FALSE, row.names = FALSE)
...
write.table(Unique_pathways_table, file = "../Figures/GSEA_and_DE_Gene_Heatmaps/PD_vs_HC/PD_vs_HC_GSEA_AllCells_ExclusivePathwaysTable.tsv", sep = "\t", quote = FALSE, row.names = FALSE)
...
Pathway_Table_Subset <- as.data.frame(Pathway_Table[c(1,2,3,5,6,7,9,10,11,13,17,19,22,23,25),])

#Pathway_Table_Subset <- as.data.frame(Pathway_Table[1:11,])

GSEA_Common_Pathways <- as.vector(Pathway_Table_Subset$`Pathway_Table[c(1, 2, 3, 5, 6, 7, 9, 10, 11, 13, 17, 19, 22, 23, 25), ]`)
...
ggsave(GSEA_Human_PFC_Heatmap,filename = "../Figures/GSEA_and_DE_Gene_Heatmaps/PD_vs_HC/PD_vs_HC_FullIntegrationOSR_GSEA_C2_Top30CommonPathways_Heatmap_Subset_ProgressReport.pdf", device = "pdf", height = 18, width = 8, units = "in")
...
write.table(PathwaysOrder, file = "../Figures/GSEA_and_DE_Gene_Heatmaps/MostCommonDEPathwaysOrder_Subset.tsv", sep = "\t", quote = FALSE, row.names = FALSE)
...
ggsave(GSEA_Human_PFC_Heatmap,filename = "../Figures/GSEA_and_DE_Gene_Heatmaps/PD_vs_HC/PD_vs_HC_GSEA_C2_Heatmap_MitochondrialPathways.pdf", device = "pdf", height = 18, width = 12, units = "in")
...
write.table(GSEA_Aggr_Table_PvalSorted_Unique, file = "../Figures/GSEA_and_DE_Gene_Heatmaps/PD_vs_HC/PD_vs_HC_GSEA_Aggr_Table_Unique_Pathways.tsv", sep = "\t", quote = FALSE, row.names = FALSE)
...
ggsave(UniquePathwayNumberSummaryChart,filename = paste("../Figures/GSEA_and_DE_Gene_Heatmaps/PD_vs_HC/PD_vs_HC_UniquePathwayNumberSummaryChart.pdf",sep = ""), device = "pdf", width = 6, height = 4, units = "in")
...
ggsave(UniquePathwayNormalisedSummaryChart,filename = paste("../Figures/GSEA_and_DE_Gene_Heatmaps/PD_vs_HC/PD_vs_HC_UniquePathwayNormalisedSummaryChart.pdf",sep = ""), device = "pdf", width = 6, height = 4, units = "in")
...
ggsave(GSEA_Human_PFC_Heatmap,filename = "../Figures/GSEA_and_DE_Gene_Heatmaps/PD_vs_HC/PD_vs_HC_GLU_Neurons_FullIntegrationOSR_GSEA_C2_Top30_Pathways_Heatmap.pdf", device = "pdf", height = 14, width = 12, units = "in")
...
ggsave(GSEA_Human_PFC_Heatmap,filename = "../Figures/GSEA_and_DE_Gene_Heatmaps/PD_vs_HC/PD_vs_HC_GLU_Neurons_FullIntegrationOSR_GSEA_C2_MostCommon30_Pathways_Heatmap.pdf", device = "pdf", height = 14, width = 12, units = "in")
...
write.table(Unique_pathways_table, file = "../Figures/GSEA_and_DE_Gene_Heatmaps/PD_vs_HC/PD_vs_HC_GSEA_GLU_Neurons_ExclusivePathwaysTable.tsv", sep = "\t", quote = FALSE, row.names = FALSE)
...
ggsave(GSEA_Human_PFC_Heatmap,filename = "../Figures/GSEA_and_DE_Gene_Heatmaps/PD_vs_HC/PD_vs_HC_GABA_Neurons_FullIntegrationOSR_GSEA_C2_Top30_Pathways_Heatmap.pdf", device = "pdf", height = 14, width = 12, units = "in")
...
ggsave(GSEA_Human_PFC_Heatmap,filename = "../Figures/GSEA_and_DE_Gene_Heatmaps/PD_vs_HC/PD_vs_HC_GABA_Neurons_FullIntegrationOSR_GSEA_C2_MostCommon30_Pathways_Heatmap.pdf", device = "pdf", height = 14, width = 12, units = "in")
...
write.table(Unique_pathways_table, file = "../Figures/GSEA_and_DE_Gene_Heatmaps/PD_vs_HC/PD_vs_HC_GSEA_GABA_Neurons_ExclusivePathwaysTable.tsv", sep = "\t", quote = FALSE, row.names = FALSE)
...
Looking at Glial Cells Neurons
...
ggsave(GSEA_Human_PFC_Heatmap,filename = "../Figures/GSEA_and_DE_Gene_Heatmaps/PD_vs_HC/PD_vs_HC_GlialCells_FullIntegrationOSR_GSEA_C2_Top30_Pathways_Heatmap.pdf", device = "pdf", height = 10, width = 12, units = "in")
...
ggsave(GSEA_Human_PFC_Heatmap,filename = "../Figures/GSEA_and_DE_Gene_Heatmaps/PD_vs_HC/PD_vs_HC_GlialCells_FullIntegrationOSR_GSEA_C2_MostCommon30_Pathways_Heatmap.pdf", device = "pdf", height = 14, width = 12, units = "in")
...
write.table(Unique_pathways_table, file = "../Figures/GSEA_and_DE_Gene_Heatmaps/PD_vs_HC/PD_vs_HC_GSEA_GlialCells_ExclusivePathwaysTable.tsv", sep = "\t", quote = FALSE, row.names = FALSE)
...
#Cell_Type <- gsub("_TREATED_vs_CTRL_GSEA_Sig_Genesets.tsv","",list.files("../Files/Subclusters_GSEA/"))
files <- list.files("../Files/Subclusters_GSEA", full.names = TRUE, pattern = "*_PD_vs_HC_GSEA_AllGenesets.tsv")
GSEA_Aggr_Table <- vroom(files, id = "Cell_Type")
GSEA_Aggr_Table$Cell_Type <- gsub("../Files/Subclusters_GSEA/|_PD_vs_HC_GSEA_AllGenesets.tsv","",GSEA_Aggr_Table$Cell_Type)
#GSEA_Aggr_Table$Cell_Type <- #gsub("GLU_Cajal_Retzius","Cajal-Retzius",GSEA_Aggr_Table$Cell_Type)
```
...
ggsave(GSEA_Human_PFC_Heatmap,filename = "../Figures/GSEA_and_DE_Gene_Heatmaps/PD_vs_HC/PD_vs_HC_GSEA_C2_Heatmap_NoPvalThreshold_MitochondrialPathways.pdf", device = "pdf", height = 18, width = 12, units = "in")

```
####################################################################################################

Mitochondrial Gene pathways Nominal Pval Threshold
...
ggsave(GSEA_Human_PFC_Heatmap,filename = "../Figures/GSEA_and_DE_Gene_Heatmaps/PD_vs_HC/PD_vs_HC_GSEA_C2_Heatmap_NominalPvalue_MitochondrialPathways.pdf", device = "pdf", height = 18, width = 12, units = "in")
...
GSEA_Aggr_Table_NLRP3 <- GSEA_Aggr_Table[grep("NLRP3",GSEA_Aggr_Table$pathway),]
...
REACTOME_TOLL_LIKE_RECEPTOR_9_TLR9_CASCADE and TLR4

```{R}

GSEA_Aggr_Table_TLR9 <- GSEA_Aggr_Table[grep("TLR9",GSEA_Aggr_Table$pathway),]


GSEA_Aggr_Table_TLR4 <- GSEA_Aggr_Table[grep("TLR4",GSEA_Aggr_Table$pathway),]


GSEA_Aggr_Table_TLR8 <- GSEA_Aggr_Table[grep("TLR8",GSEA_Aggr_Table$pathway),]
```
...
Doing a brief analysis of the pathways called as being significant
...
#Cell_Type <- gsub("_TREATED_vs_CTRL_GSEA_Sig_Genesets.tsv","",list.files("../Files/Subclusters_GSEA/"))
files <- list.files("../Files/Subclusters_GSEA_C2CP", full.names = TRUE)
GSEA_Aggr_Table <- vroom(files, id = "Cell_Type")
GSEA_Aggr_Table$Cell_Type <- gsub("../Files/Subclusters_GSEA_C2CP/|_DBH_KD_vs_WT_GSEA_SigBHCorrection_Genesets.tsv","",GSEA_Aggr_Table$Cell_Type)
GSEA_Aggr_Table$Cell_Type <- gsub("GLU_Cajal_Retzius","Cajal-Retzius",GSEA_Aggr_Table$Cell_Type)
GSEA_Aggr_Table$Cell_Type <- gsub("Oligo_Endo","Oligo/Endo",GSEA_Aggr_Table$Cell_Type)
GSEA_Aggr_Table$Cell_Type <- gsub("_"," ",GSEA_Aggr_Table$Cell_Type)
```


```{R}
GSEA_Aggr_Table_Unqiue <- GSEA_Aggr_Table %>% group_by(pathway) %>% summarise(mean_NES = mean(NES))



```

Mitochondrial related gene sets: 	
...
Looking at leading edge genes

GABA_Neurons: Cox8a, Cox7c, Cox4i1, Atp6v0c, Atp1a1, Atp5b, Atp6v1e1, Atp6v0b, Atp6v1d, Atp5a1, Atp6v1b2
GLU_Neuron: Atp6v0c, Cox4i1, Cox8a, Cox7c, Atp5b, Atp1a3, Atp5a1

KEGG_OXPHOS <- c("Cox8a", "Cox7c", "Cox4i1", "Atp6v0c", "Atp1a1", "Atp5b", "Atp6v1e1", "Atp6v0b", "Atp6v1d", "Atp5a1", "Atp6v1b2", "Atp1a3")
...
#Cell_Type <- gsub("_TREATED_vs_CTRL_GSEA_Sig_Genesets.tsv","",list.files("../Files/Subclusters_GSEA/"))
files <- list.files("../Files/DE_Genes_3CountFilter", pattern = "AllGenes.*", full.names = TRUE)
DE_Aggr_Table <- vroom(files, id = "Cell_Type")
DE_Aggr_Table$Cell_Type <- gsub("../Files/DE_Genes_3CountFilter/|AllGenes_|_Markers_TREATED_vs_CTRL.csv","",DE_Aggr_Table$Cell_Type)

DE_Aggr_Table$Directionality <- "Upregulated"
DE_Aggr_Table$Directionality[DE_Aggr_Table$avg_log2FC < 0] <- "Downregulated"
```
...
DE_Aggr_Table_KEGG_OXPHOS <- DE_Aggr_Table[DE_Aggr_Table$gene %in% KEGG_OXPHOS,]
...
MYPalette <- c("magenta","#C228C8","#813384","#000000","#817E3E","#BEB72F","#FFF300")

DE_Aggr_Table_KEGG_OXPHOS_LogFC_BarChart <- ggplot(DE_Aggr_Table_KEGG_OXPHOS, aes(fill = Directionality, y=avg_log2FC, x=gene)) + 
    geom_bar(stat="identity")  + 
  ylab("log2FC") +
  xlab("Gene") +
...
ggsave(DE_Aggr_Table_KEGG_OXPHOS_LogFC_BarChart,filename = paste("../Figures/DE_Aggr_Table_KEGG_OXPHOS_LogFC_BarChart.pdf",sep = ""), device = "pdf", width = 6, height = 14, units = "in")
...
DE_Aggr_Table_KEGG_OXPHOS_GLU <- DE_Aggr_Table_KEGG_OXPHOS[DE_Aggr_Table_KEGG_OXPHOS$Cell_Type %in% "GLU_Neurons",]

DE_Aggr_Table_KEGG_OXPHOS_GLU_LogFC_BarChart <- ggplot(DE_Aggr_Table_KEGG_OXPHOS_GLU, aes(fill = Directionality, y=avg_log2FC, x=gene)) + 
...
ggsave(DE_Aggr_Table_KEGG_OXPHOS_GLU_LogFC_BarChart,filename = paste("../Figures/DE_Aggr_Table_KEGG_OXPHOS_GLU_LogFC_BarChart.pdf",sep = ""), device = "pdf", width = 6, height = 4, units = "in")

```


ggplot(DE_Aggr_Table_KEGG_OXPHOS, aes(fill=Case, y=mean, x=variable)) + 
...
DE_Aggr_Table_KEGG_OXPHOS_GABA <- DE_Aggr_Table_KEGG_OXPHOS[DE_Aggr_Table_KEGG_OXPHOS$Cell_Type %in% "GABA_Neurons",]


ggplot(DE_Aggr_Table_KEGG_OXPHOS_GABA, aes(fill = Directionality, y=avg_log2FC, x=gene)) + 
    geom_bar(stat="identity", width = 0.5)  + 
  ylab("log2FC") +
  xlab("Gene") +
  scale_fill_manual(values = MYPalette[c(1,7)]) +
...
DE_Aggr_Table_KEGG_OXPHOS_GABA_LogFC_BarChart <- ggplot(DE_Aggr_Table_KEGG_OXPHOS_GABA, aes(fill = Directionality, y=avg_log2FC, x=gene)) + 
    geom_bar(stat="identity", width = 0.5)  + 
  ylab("log2FC") +
  xlab("Gene") +
  scale_fill_manual(values = MYPalette[c(1,7)]) +
...
ggsave(DE_Aggr_Table_KEGG_OXPHOS_GABA_LogFC_BarChart,filename = paste("../Figures/DE_Aggr_Table_KEGG_OXPHOS_GABA_LogFC_BarChart.pdf",sep = ""), device = "pdf", width = 6, height = 4, units = "in")
...
```{R}
MOOTHA_MT <- c("Lars2", "Cox4i1", "Cox8a", "Cox7c", "Slc25a4", "Slc9a9", "Atp5b", "Slc1a2", "Slc25a3", "Snca", "Slf2", "Ywhae", "Gnas", "Erbb4")

DE_Aggr_Table_MOOTHA_MT <- DE_Aggr_Table[DE_Aggr_Table$gene %in% MOOTHA_MT,]
...
ggplot(DE_Aggr_Table_MOOTHA_MT, aes(fill = Directionality, y=avg_log2FC, x=gene)) + 
  geom_bar(stat="identity")  + 
  ylab("log2FC") +
  xlab("Gene") +
  scale_fill_manual(values = MYPalette[c(1,7)]) +
...
DE_Aggr_Table_MOOTHA_MT_LogFC_BarChart <- ggplot(DE_Aggr_Table_MOOTHA_MT, aes(fill = Directionality, y=avg_log2FC, x=gene)) + 
  geom_bar(stat="identity")  + 
  ylab("log2FC") +
  xlab("Gene") +
  scale_fill_manual(values = MYPalette[c(1,7)]) +
...
ggsave(DE_Aggr_Table_MOOTHA_MT_LogFC_BarChart,filename = paste("../Figures/DE_Aggr_Table_MOOTHA_MT_LogFC_BarChart.pdf",sep = ""), device = "pdf", width = 6, height = 14, units = "in")
...
DE_Aggr_Table_MOOTHA_MT_GLU <- DE_Aggr_Table_MOOTHA_MT[DE_Aggr_Table_MOOTHA_MT$Cell_Type %in% "GLU_Neurons",]

DE_Aggr_Table_MOOTHA_MT_GLU_LogFC_BarChart <- ggplot(DE_Aggr_Table_MOOTHA_MT_GLU, aes(fill = Directionality, y=avg_log2FC, x=gene)) + 
  geom_bar(stat="identity", width = 0.5)  + 
  ylab("log2FC") +
  xlab("Gene") +
  scale_fill_manual(values = MYPalette[c(1,7)]) +
...
ggsave(DE_Aggr_Table_MOOTHA_MT_GLU_LogFC_BarChart,filename = paste("../Figures/DE_Aggr_Table_MOOTHA_MT_GLU_LogFC_BarChart.pdf",sep = ""), device = "pdf", width = 6, height = 4, units = "in")

```


ggplot(DE_Aggr_Table_MOOTHA_MT, aes(fill=Case, y=mean, x=variable)) + 
  geom_bar(position = position_dodge(), stat="identity")  + 
  geom_errorbar(aes(x = variable , ymin = mean-SE, ymax = mean+SE, colour = Case), width = 0.9, alpha = 0.9, size = 0.3, position = position_dodge(.9)) +
  ylab("Mean Expression") +
  xlab("Gene") +
...
DE_Aggr_Table_MOOTHA_MT_GABA <- DE_Aggr_Table_MOOTHA_MT[DE_Aggr_Table_MOOTHA_MT$Cell_Type %in% "GABA_Neurons",]


ggplot(DE_Aggr_Table_MOOTHA_MT_GABA, aes(fill = Directionality, y=avg_log2FC, x=gene)) + 
  geom_bar(stat="identity", width = 0.5)  + 
  ylab("log2FC") +
  xlab("Gene") +
  scale_fill_manual(values = MYPalette[c(1,7)]) +
...
DE_Aggr_Table_MOOTHA_MT_GABA_LogFC_BarChart <- ggplot(DE_Aggr_Table_MOOTHA_MT_GABA, aes(fill = Directionality, y=avg_log2FC, x=gene)) + 
  geom_bar(stat="identity", width = 0.5)  + 
  ylab("log2FC") +
  xlab("Gene") +
  scale_fill_manual(values = MYPalette[c(1,7)]) +
...
ggsave(DE_Aggr_Table_MOOTHA_MT_GABA_LogFC_BarChart,filename = paste("../Figures/DE_Aggr_Table_MOOTHA_MT_GABA_LogFC_BarChart.pdf",sep = ""), device = "pdf", width = 6, height = 4, units = "in")
