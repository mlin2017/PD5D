...
saveRDS(SeuratObject,"/n/scratch3/users/j/jap0606/FullIntegration_OutlierSamplesRemoved_HealthyControls_5agebracket/FullIntegrationOSR_HealthyControls_5agebracket_MTG_Part2.rds")
