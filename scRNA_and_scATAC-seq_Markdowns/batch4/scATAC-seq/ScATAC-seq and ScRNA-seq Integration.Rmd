...
saveRDS(Batch4_ATAC,"./atac_merge_filtered_matched_100.rds")
...
ATAC_Batch4=readRDS("Files/Batch4_ATAC_merged.rds")
...
```{R}
Batch4_ATAC <- RenameIdents(Batch4_ATAC, `0` = "Oligodendrocytes", `1` = "GLU Neurons", `2` = "Novel Cluster 2",
