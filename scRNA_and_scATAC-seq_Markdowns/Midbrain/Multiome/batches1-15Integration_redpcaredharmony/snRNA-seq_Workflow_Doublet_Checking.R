...
SeuratObject <- readRDS("/n/scratch3/users/j/jap0606/Midbrain/Batches1-15_Midbrain_reducedpcareducedharmony_Part2.rds")
...
CellNumberQCFilter <- CellNumberQC[CellNumberQC$Number.of.Cells >= 100,]

SampleNumberQCFilter <- SampleNumberQC[SampleNumberQC$Number.of.Samples >= 10,]
...
CellNumberQCFilter <- cells_per_cluster_table[cells_per_cluster_table$Number.of.Cells >= 100,]

SampleNumberQCFilter <- samples_per_cluster_table[samples_per_cluster_table$Number.of.Samples >= 10,]
...
saveRDS(SeuratObjectSinglets,"/n/scratch3/users/j/jap0606/Midbrain/Batches1-15_Midbrain_reducedpcareducedharmony_Part3.rds")
