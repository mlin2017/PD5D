...
SeuratObject <- readRDS("/n/scratch3/users/j/jap0606/Midbrain/Batches1-15_Midbrain_noharmony_Part1.rds")

SeuratObject <- FindNeighbors(SeuratObject, reduction = "glmpca", dims = 1:40)
SeuratObject <- FindClusters(SeuratObject, resolution = 0.6, algorithm = 4, method = "igraph")
SeuratObject <- RunUMAP(SeuratObject, reduction = "glmpca", dims = 1:40)
...
saveRDS(SeuratObject,"/n/scratch3/users/j/jap0606/Midbrain/Batches1-15_Midbrain_noharmony_Part2.rds")
