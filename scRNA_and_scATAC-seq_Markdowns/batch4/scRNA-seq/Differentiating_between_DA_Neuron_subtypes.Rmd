...
wilcoxfun <- function (x) {
        tempdf <- melted_cell_type_number_df2_fractions[melted_cell_type_number_df2_fractions$Var1 == x,]
...
```{R}
lapply(unique(melted_cell_type_number_df2_fractions$Var1), wilcoxfun)
```
