...
```{R}
MTGandMidbrainIntegration <- merge(Batch8_MTG, y = Pilot_2_MB, add.cell.ids = c("Batch8_MTG", "Pilot_2_MB"), project = "PD5D")
...
```{R}
#saveRDS(MTGandMidbrainIntegration,"Files/MTGandMidbrainIntegration_precluster.rds")

MTGandMidbrainIntegration <- readRDS("Files/MTGandMidbrainIntegration_precluster.rds")
```
