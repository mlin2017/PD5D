...
SeuratObject <- readRDS("/n/scratch3/users/j/jap0606/FullIntegration_OutlierSamplesRemoved_NHSC/FullIntegrationOSR_MTG_NHSC_Part1.rds")

SeuratObject <- FindNeighbors(SeuratObject, reduction = "harmony", dims = 1:64)
SeuratObject <- FindClusters(SeuratObject, resolution = 1.2, algorithm = 4, method = "igraph")
SeuratObject <- RunUMAP(SeuratObject, reduction = "harmony", dims = 1:64)
...
saveRDS(SeuratObject,"/n/scratch3/users/j/jap0606/FullIntegration_OutlierSamplesRemoved_NHSC/FullIntegrationOSR_MTG_NHSC_Part2.rds")
...
MarkerGenes <- c("ENO2","RBFOX3","SLC17A6","SLC17A7","SLC32A1","GAD1","GAD2","AQP4","GFAP","PLP1","MBP","VCAN","BCAN","CX3CR1","P2RY12","FLT1","CLDN5","IL7R","CD96","CD8A","RELN","CALB2","CNR1","PTPRC","CD27","CD28","CCR7","PRF1")
...
ggsave(Batch1to22_barchart,filename = "Files/Marker_Barchart", device = "pdf", width = 12, height = 14, units = "in")
