...
Run Harmony
```{r}
Batch567_MTG <- RunHarmony(Batch567_MTG, group.by.vars = c("batch","sex","age_bracket","sample_ID"), reduction = "glmpca", plot_convergence = TRUE, theta = c(0.5,0.5,0.5,0.5))
```
...
ggsave(Harmony2Dimensions_Batch_Coloured, filename = "Figures/Harmony2Dimensions_BATCHONLYCorrected_BatchColoured_scRNA_seq_Batch567.pdf", device = "pdf", width = 6, height = 4, units = "in")
...
Harmony2Dimensions_Case_Coloured <- DimPlot(object = Batch567_MTG, reduction = "harmony", pt.size = .1, group.by = "case") + 
        theme(axis.text = element_text(size=8),
              axis.title = element_text(size = 12),
              legend.text = element_text(size = 8),
              title = element_text(size = 12),
...
Harmony2Dimensions_Case_Coloured

ggsave(Harmony2Dimensions_Case_Coloured, filename = "Figures/Harmony2Dimensions_BATCHONLYCorrected_CaseColoured_scRNA_seq_Batch567.pdf", device = "pdf", width = 6, height = 4, units = "in")
...
ggsave(UMAPclusters, filename = "Figures/Unassigned_BatchSexAgeSampleHarmony_GLMAPCA_UMAPclusters_scRNA_seq_Batch123_MTG.pdf", device = "pdf", width = 6, height = 4, units = "in")
```
...
ggsave(UMAPclusters, filename = "Figures/Unassigned_BatchSexAgeSampleHarmony_CaseSplit_GLMPCA_UMAPclusters_scRNA_seq_Batch123_MTG.pdf", device = "pdf", width = 6, height = 10, units = "in")
```
...
ggsave(UMAPclusters, filename = "Figures/Unassigned_BatchSexAgeSampleHarmony_CaseGroup_GLMPCA_UMAPclusters_scRNA_seq_Batch123_MTG.pdf", device = "pdf", width = 6, height = 4, units = "in")
```
...
```{R}
VlnPlot(Batch567_MTG, features = c("SLC17A6"),pt.size = 1)
```

```{R}
VlnPlot(Batch567_MTG, features = c("SLC17A7"),pt.size = 0)
```
1,2,3,6,8,10,11,12,17 - Glu?
...
Batch567_MTG <- RenameIdents(Batch567_MTG, `0` = "Oligodendrocytes", `1` = "GLU Neurons", `2` = "Novel Cluster 2",
                      ...
                      `6` = "GLU Neurons", `7` = "Astrocytes 2", `8` = "GLU Neurons",`9` = "GABA Neurons",
                      `10` = "Novel Cluster 10", `11` = "Novel Cluster 11",`12` = "Novel Cluster 12",
                      `13` = "Microglia",`14` = "Astrocytes 1",
