...
SeuratObject <- subset(SeuratObject, subset = case %in% "HC")
...
saveRDS(SeuratObject,"/n/scratch3/users/j/jap0606/batch1-22_HC/Batch1-22_MTG_HC_CombinedFilteredMatrix.rds")
