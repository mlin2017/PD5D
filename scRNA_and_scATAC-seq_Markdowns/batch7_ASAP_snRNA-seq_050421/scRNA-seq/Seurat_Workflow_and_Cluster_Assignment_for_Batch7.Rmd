...
```
 ...
 Glu_Neurons = 0,1,2,3,7,8,13,15,16,18,19 - Glu?
...
```{r}
Batch7_MTG <- RenameIdents(Batch7_MTG, `0` = "Glu_Neurons", `1` = "Glu_Neurons", `2` = "Glu_Neurons",
                      `3` = "Glu_Neurons", `4` = "Oligodendrocytes", `5` = "GABA Neurons",
                      `6` = "GABA Neurons", `7` = "Glu_Neurons", `8` = "Glu_Neurons",`9` = "Astrocytes",
                      `10` = "GABA Neurons", `11` = "Microglia",`12` = "Novel Cluster 12",
                      `13` = "Glu_Neurons",`14` = "Endothelial",
                      `15` = "Glu_Neurons", `16`="GABA Neurons", `17`="OPCs", `18`="Glu_Neurons", `19`="Oligodendrocytes",  `20`="Astrocytes", `21` = "Novel Cluster 21", `22` = "Endothelial")
```
