...
SeuratObject_ElbowPlot <- ElbowPlot(SeuratObject, reduction = "glmpca", ndims = 75)

ggsave2("Figures/SeuratObject_ElbowPlot.pdf", SeuratObject_ElbowPlot, device = "pdf", width = 4, height = 4, units = "in")

saveRDS(SeuratObject,"/n/scratch3/users/j/jap0606/Midbrain/Batches1-15_Midbrain_noharmony_Part1.rds")
