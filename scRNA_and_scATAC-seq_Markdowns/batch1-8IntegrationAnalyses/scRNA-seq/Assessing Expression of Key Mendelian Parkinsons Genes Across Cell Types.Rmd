...
data_barplot_melt_sum <- read.table("Files/Parkisons_Mendelian_Genes_BarChartTable.tsv", header = TRUE)
...
ggsave(ParkinsonsGeneBarChartGrid,filename = "Files/Batch1-8_ParkinsonsGenes_BarchartGrid.pdf", device = "pdf", width = 12, height = 12, units = "in")
